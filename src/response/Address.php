...
namespace isudakoff\dadata\response;
...
class Address extends Model
{
    ...
    public static function fromDaDataSuggestion($suggestion)
    {
        $model = new self();
        $model->load($suggestion['data'], '');
        $model->json = json_encode($suggestion['data'], JSON_UNESCAPED_UNICODE);
